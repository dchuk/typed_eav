...
| 1 | T013–T015 remaining correctness repair | Workers | queued | T012 | No index redesign before correctness; serialize exact partitions, query operands, then defaults | Four Phase 0 probes remain intentionally pending | — | Remove all remaining intentional pending markers before Gate 1 |
