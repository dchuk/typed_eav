...
| 1 | T015 remaining default-domain repair | Worker | queued | T014 | Reuse Value domain rules without throwaway persistence or duplicated type rules | One Phase 0 probe remains intentionally pending | — | Remove final pending marker before Gate 1 |
