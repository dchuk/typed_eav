...
| 1 | T012–T015 correctness repair | Workers | queued | T008/T010 | No index redesign before correctness; serialize Value state, exact partitions, query operands, then defaults | Gate 0 worker packages | — | Remove all 8 intentional pending markers before Gate 1 |
