...
| 1 | T014–T015 remaining correctness repair | Workers | queued | T013 | No index redesign before correctness; serialize query operands, then defaults | Three Phase 0 probes remain intentionally pending | — | Remove all remaining intentional pending markers before Gate 1 |
