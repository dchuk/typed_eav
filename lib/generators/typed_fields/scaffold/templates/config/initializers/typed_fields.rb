...
#
# Class-level queries like `Contact.where_typed_fields(...)` consult this
# resolver when no explicit `scope:` kwarg or `TypedFields.with_scope(...)`
# block is active. If the resolver returns nil and the model declared
# `has_typed_fields scope_method: ...`, queries raise
# `TypedFields::ScopeRequired` (fail-closed).
#
...
TypedFields.configure do |c|
  ...
  # escape hatch: `TypedFields.unscoped { ... }`.
